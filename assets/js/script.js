...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Anamul";
...
var typed = new Typed(".typing-text", {
    strings: ["💻 Frontend Developer", "💻 Backend Developer", "💻 Professional Graphics Designer","💻 UX Designer", "💻 Android Developer", "🤖 Machine Learning Engineer 🇦🇮"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
